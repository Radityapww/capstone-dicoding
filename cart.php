            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>' class="btn btn-primary">Hapus</a>
                            <!-- <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'>Hapus</a></th> -->
                    </tr>
                    ...
                    <tr>
                        <th></th><th></th><th></th><th><a href="products.php" class="btn btn-primary">Kembali</a>
                    </tr>
                </tbody>
            </table>
        </div>
